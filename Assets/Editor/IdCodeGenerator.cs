...
namespace Tag.NutSort.Editor
{
    public class IdCodeGenerator : AssetPostprocessor
    {
        ...
        {
            { EditorConstant.MAPPING_IDS_PATH + "/BoosterIdMappings.asset", "BoosterIdConstant" },
            { EditorConstant.MAPPING_IDS_PATH + "/CurrencyIdMappings.asset", "CurrencyConstant" },
            { EditorConstant.MAPPING_IDS_PATH + "/NutColorIdMappings.asset", "NutColorIdConstant" },
            { EditorConstant.MAPPING_IDS_PATH + "/NutTypeIdMappings.asset", "NutTypeIdConstant" },
            { EditorConstant.MAPPING_IDS_PATH + "/ScrewTypeIdMappings.asset", "ScrewTypeIdConstant" },
        };
        ...
        private static void GenerateAllIdConstants()
        {
            ...
            sb.AppendLine("//// WARNING: This file is auto-generated by IdCodeGenerator.cs");
            ...
            foreach (var mappingEntry in MappingAssets)
            {
                ...
                else
                {
                    ...
                    foreach (var pair in sortedMappings)
                    {
                        ...
                        string identifier = SanitizeIdentifier(originalName).ToUpper();
