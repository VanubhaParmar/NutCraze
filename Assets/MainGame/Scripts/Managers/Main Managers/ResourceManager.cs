...
namespace Tag.NutSort
{
    ...
    {
        #region PRIVATE_VARS
        [SerializeField] private AllLevelDataSO normalLevelDataSO;
        ...
        [SerializeField] private Sprite noAdsSprite;
        #endregion
        ...
        #region PROPERTIES
        public int TotalLevelCount => normalLevelDataSO.TotalLevelCount;
        public static Material GrayScale => Instance.grayScale;
        public static Sprite NoAdsSprite => Instance.noAdsSprite;
        ...
        public static SurpriseNutAnimation NutRevealAnimation => Instance.nutRevealAnimation;
        #endregion
        ...
        {
            return normalLevelDataSO.GetLevelData(levelNo);
        }
